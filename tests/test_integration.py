...
from simple_rules_engine import export_rule_data
from simple_rules_engine.actions import BaseActions, rule_action
from simple_rules_engine.engine import check_condition
from simple_rules_engine.fields import FIELD_NUMERIC, FIELD_SELECT, FIELD_TEXT
from simple_rules_engine.variables import BaseVariables, boolean_rule_variable, numeric_rule_variable, \
...
class SomeActions(BaseActions):
    ...
    @rule_action(label="woohoo", params={
        "bar": FIELD_TEXT
    })
