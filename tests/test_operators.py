...
from simple_rules_engine.operators import (BooleanType, NumericType, SelectMultipleType, SelectType, StringType)
...
class StringOperatorTests(TestCase):
    ...
    def test_string_not_contains(self):
        self.assertTrue(StringType("asdf").not_contains("hello"))
        self.assertTrue(StringType("ElL").not_contains("hello"))
        self.assertFalse(StringType("ell").not_contains("hello"))
        self.assertFalse(StringType("he").not_contains("hello"))
        self.assertFalse(StringType("lo").not_contains("hello"))
...
class NumericOperatorTests(TestCase):
    ...
    def test_numeric_type_validates_and_casts_decimal(self):
        ...
        ten_float = 10.0
        ten_long = int(10)
        ten_var_dec = NumericType(ten_dec)
